...
from core.json_to_cpp import json_to_cpp


class JsonCppPanel(BasePanel):
    """输入 JSON，输出 C++ 类定义（std::string、int、vector、嵌套类等）。"""
    ...
    def process(self, text):
        ...
        return json_to_cpp(text, root_class_name=name)
